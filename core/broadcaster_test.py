...
class TestBroadcaster(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_new_broadcaster(self):
        ...
        self.assertEqual(len(b.listeners), 0, "NewBroadcaster should initialize with an empty listeners map")
    ...
    async def test_subscribe(self):
        ...
        self.assertEqual(len(b.listeners), 1, "Should have one listener after subscribe")
    ...
    async def test_unsubscribe(self):
        ...
        self.assertEqual(len(b.listeners), 0, "Should have no listeners after unsubscribe")
    ...
    async def test_broadcast(self):
        ...
        for _ in range(num_messages * 2):
            try:
                ...
                try:
                    msg = ch1.get_nowait()
                    self.assertLess(msg, num_messages, "Channel 1 should receive valid message")
                    messages_received += 1
                    continue
                ...
                try:
                    msg = ch2.get_nowait()
                    self.assertLess(msg, num_messages, "Channel 2 should receive valid message")
                    messages_received += 1
                except asyncio.QueueEmpty:
                    pass
        ...
        self.assertGreater(messages_received, 0, f"Should have received some messages, got {messages_received}")
