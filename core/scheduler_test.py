"""
Test cases for the goless-based scheduler - mirrors Go tests.
"""
...
class TestScheduler(unittest.TestCase):
    """Test the goless-based scheduler implementation."""
    ...
    def test_schedule_task(self):
        ...
        try:
            ...
            while len(executed) == 0 and time.time() - start_time < 0.5:
                gevent.sleep(0.01)  # Yield to allow goless goroutines to execute
